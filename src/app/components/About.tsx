    ...
    <section id="about" className="bg-white">
      ...
      <div className="bg-cyan-500 py-10 text-center px-4 sm:px-2">
        <p className="text-white text-lg sm:text-xl font-semibold">
          ...
          <span className="text-white font-semibold no-underline">
            Pratika Rane
          </span>
        </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        <div className="space-y-6 flex flex-col items-center lg:items-start">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg shadow-sm flex items-center gap-4 w-full max-w-[580px] h-[142px] px-4 py-3">
            <div className="w-full h-full sm:w-[250px] sm:h-[138px] overflow-hidden rounded-lg">
              <Image
            ...
            <div className="pr-2 text-left">
              <h3 className="font-semibold text-black text-sm sm:text-lg py-1">
                Career Objective
              </h3>
              <p className="text-black text-xs sm:text-sm py-1">
                To contribute to the pharmaceutical industry through expertise
                in quality systems and compliance, while supporting continuous
                improvement and business goals in a globally respected
                organization.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg shadow-sm flex items-center gap-4 w-full max-w-[580px] h-[142px] px-4 py-3">
            ...
            <div className="pr-2 text-left">
              ...
              <p className="text-black text-xs sm:text-sm py-1">
                Detail-oriented, analytical, and collaborative professional with
                strong documentation and audit readiness skills, committed to
                continuous learning and high performance under pressure.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg shadow-sm flex items-center gap-4 w-full max-w-[580px] h-[142px] px-4 py-3">
            ...
            <div className="pr-2 text-left">
              ...
              <p className="text-black text-xs sm:text-sm py-1">
                Skilled in managing deviations, complaints, and compliance using
                tools like TrackWise and NovoGlow, with a strong foundation in
                lab techniques and strategic quality oversight.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-[520px] mx-auto lg:mx-0 h-auto lg:h-[475px]">
          <div className="bg-gray-50 border border-gray-200 p-4 sm:p-6 rounded-lg shadow-sm h-full flex flex-col justify-between space-y-6">
            ...
            {/* Hobbies & Interests */}
            <div className="mb-3">
              <h3 className="font-semibold text-black text-lg sm:text-2xl mb-4">
                Hobbies & Interests
              </h3>
