...
export default function About() {
  return (
    <section id="about" className="bg-white">
      ...
      {/* Content */}
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-2 gap-4 items-start">
        {/* Left Side Cards */}
        <div className="space-y-6 flex flex-col items-center lg:items-start">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg shadow-sm flex items-center gap-4 w-full max-w-[580px] h-[142px] px-4 py-3">
            <div className="w-[200px] sm:w-[250px] sm:h-[138px] h-[134px] overflow-hidden rounded-lg">
              <Image
  ...
  <div className="bg-gray-50 border border-gray-200 p-6 rounded-lg shadow-sm h-full flex flex-col justify-between space-y-6">
    ...
    {/* Hobbies & Interests */}
    <div className="mb-3">
      <h3 className="font-semibold text-2xl mb-4">Hobbies & Interests</h3>
      <ul className="list-disc list-inside text-gray-800 text-sm space-y-2 marker:text-cyan-600 px-2">
